...
// Сделано. Переделать в new Promise()
/*let getRequest = (url) => {
...
class ProductsList extends List {
    ...
    _init() {
        ...
        document.querySelector('.navForm').addEventListener('submit', e => {
            e.preventDefault();
            this.filter(document.querySelector('.searchInput').value)
        })
    }
}
            ...
            .then(data => {
                if (data.result === 1) {
                    ...
                    if (find) {
                        ...
                        // goods -  "опорный" массив, отражающий список товаров, которые нужно отрендерить.
